...
\cventry{2018--Present}{Data Engineer}{Vituity}{Durham, NC}{}
...
\section{Projects}
\cvitem{}{\textbf{PyRaceView.} Extracted GPS data from NASCAR RaceView. Reverse engineered a Flash application to decode byte streams from a websocket using NumPy for bitwise arithmetic.
...
\cvitem{Technologies}{Apache Spark, Apache Airflow, Hadoop, Excel, Git, React Native, SQL Server, PostgreSQL}
