...
\cventry{2019--Present}{Data Scientist}{Cisco Systems}{Research Triangle, NC}{}
...
\section{Projects}
\cvitem{}{\textbf{PyRaceview.} Python package to extract data such as car gps position, throttle, and brake from NASCAR Raceview.
...
\cvitem{Technologies}{Prefect, Apache Spark, Apache Airflow, Hadoop, Excel, Git, React Native, SQL Server, PostgreSQL}
